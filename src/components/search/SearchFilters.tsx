    ...
    <div className="space-y-0 animate-in fade-in">
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen} className="md:hidden">
        <CollapsibleTrigger asChild>
          <Button 
            variant="outline" 
            className="w-full flex items-center justify-between p-4 border-x border-b border-border"
          >
          ...
          <div className="space-y-6 bg-card/50 rounded-lg p-4 border border-border">
            ...
            <div className="flex flex-col gap-3 pt-4">
              <Button 
                ...
                size="sm" 
                onClick={onReset}
                className="w-full h-10 text-xs font-medium border border-border"
              >
      ...
      <div className="bg-card/50 border-x border-b border-border">
