...
import { User, PenLine, Clock, Play, Eye, Heart, MessageSquare, Timer, Zap, Download, ExternalLink } from "lucide-react";
    ...
    <TableHeader>
      <TableRow>
        ...
        <TableHead className="text-center">
          <Tooltip>
            <TooltipTrigger>
              <ExternalLink className="h-4 w-4 mx-auto text-rose-400" />
            </TooltipTrigger>
